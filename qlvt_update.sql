...
CREATE TABLE `phieu_xuat_kho` (
  ...
  `id_bo_phan_yc` int(11) NOT NULL,
  `ly_do` text NOT NULL,
  `id_tai_xe` int(11) NOT NULL,
  `id_xe` int(11) NOT NULL,
  `nguoi_ky` text DEFAULT NULL,
...
--
-- Cấu trúc bảng cho bảng `vat_tu_boc_tach`
--

CREATE TABLE `vat_tu_boc_tach` (
  `id` int(11) NOT NULL,
  `so_luong` float NOT NULL,
  `id_cong_trinh` int(11) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `vat_tu_xuat`
--
...
--
-- Chỉ mục cho bảng `auth_item_group`
--
...
--
-- Chỉ mục cho bảng `pcounter_by_day`
--
ALTER TABLE `pcounter_by_day`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `pcounter_save`
--
...
--
-- Chỉ mục cho bảng `phieu_xuat_kho`
--
ALTER TABLE `phieu_xuat_kho`
  ADD PRIMARY KEY (`id`),
  ADD KEY `xe` (`id_xe`),
  ADD KEY `yeu_cau` (`id_bo_phan_yc`),
  ADD KEY `nguoi_duyet` (`id_nguoi_duyet`),
  ADD KEY `tai_xe` (`id_tai_xe`),
  ADD KEY `cong_trinh` (`id_cong_trinh`);
...
--
-- Chỉ mục cho bảng `user_visit_log`
--
...
ALTER TABLE `vat_tu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `loai_vat_tu` (`id_loai_vat_tu`);

--
-- Chỉ mục cho bảng `vat_tu_boc_tach`
--
ALTER TABLE `vat_tu_boc_tach`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vat_tu` (`id_vat_tu`),
  ADD KEY `id_cong_trinh` (`id_cong_trinh`);

--
-- Chỉ mục cho bảng `vat_tu_xuat`
--
ALTER TABLE `vat_tu_xuat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_phieu_xuat_kho` (`id_phieu_xuat_kho`),
  ADD KEY `id_nguoi_duyet` (`id_nguoi_duyet`),
  ADD KEY `id_vat_tu` (`id_vat_tu`);
...
--
-- AUTO_INCREMENT cho bảng `pcounter_by_day`
--
ALTER TABLE `pcounter_by_day`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT cho bảng `phieu_xuat_kho`
--
ALTER TABLE `phieu_xuat_kho`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `vat_tu_xuat`
--
ALTER TABLE `vat_tu_xuat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `vat_tu_boc_tach`
--
ALTER TABLE `vat_tu_boc_tach`
...
--
-- Các ràng buộc cho bảng `vat_tu_xuat`
--
ALTER TABLE `vat_tu_xuat`
