...
/* @var $searchModel app\models\LoaiVatTuSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Loại vật tư';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="loai-vat-tu-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Loai Vat Tus','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i>Danh sách Loại vật tư',
