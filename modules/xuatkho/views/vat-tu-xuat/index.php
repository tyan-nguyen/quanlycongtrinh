...
/* @var $searchModel app\models\VatTuXuatSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Vat Tu Xuats';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="vat-tu-xuat-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Vat Tu Xuats','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Vat Tu Xuats listing',
