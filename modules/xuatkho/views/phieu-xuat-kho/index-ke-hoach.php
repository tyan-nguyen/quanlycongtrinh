...
<div class="phieu-xuat-kho-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách phiếu xuất kho theo Đề nghị '. Html::a('#' . $model->soPhieu , ['/kehoachxuatkho/phieu-xuat-kho/update', 'id'=>$model->id], ['role'=>'modal-remote','title'=> 'Kế hoạch ' . $model->soPhieu, 'style'=>'text-decoration:underline']),
