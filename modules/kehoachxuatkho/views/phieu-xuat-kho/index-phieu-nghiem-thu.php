...
$this->title = 'Duyệt Phiếu Xuất Kho';
...
<div class="phieu-xuat-kho-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columns-phieu-nghiem-thu.php'),
            'toolbar'=> [
                ['content'=>
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách phiếu xuất kho sắp hoàn thành cần nghiệm thu',
