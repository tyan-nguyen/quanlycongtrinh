...
<div class="container flex">
	...
	<div style="width:100%;display: flex; justify-content: center;">
		<img src="/images/logo_admin_small.png" width="100px"/>
	</div>
	<div style="width:100%;display: flex; justify-content: center;">
		<h3 style="color:red;font-weight:bold;padding:10px;margin:0;">QUẢN LÝ CÔNG TRÌNH</h3>
	</div>
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">ĐĂNG NHẬP PHẦN MỀM</h3>
		</div>
